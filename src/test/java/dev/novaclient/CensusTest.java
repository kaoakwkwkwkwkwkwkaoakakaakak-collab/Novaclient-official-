...
class CensusTest {
    ...
    @Test
    @DisplayName("the registry holds the advertised 71 modules across 6 tabs")
    void advertisedCountsMatchTheRegistry() {
        ...
        assertEquals(14, manager.inCategory(Category.VISUAL).size(), "visual tab");
        ...
        assertEquals(71, manager.all().size(), "total modules");
