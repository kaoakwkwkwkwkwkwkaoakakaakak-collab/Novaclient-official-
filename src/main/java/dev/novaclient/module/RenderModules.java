...
final class RenderModules {
    ...
    static void register(ModuleManager manager) {
        ...
        ActiveModule sky = new ActiveModule("Custom Sky", "Dims or hides the skybox.",
                Category.RENDER);
        sky.register(new SliderSetting("Brightness", 100, 0, 100, 5, "%"));
        sky.register(new ToggleSetting("Hide Stars", false));
